...
/**
 * RPSLSpock methods used in Main
 * @author Christopher Kanke
 */
public class RPSLSpock {
    ...
    /**
     * Validates human's choice
     * @param pick human's choice
     * @return human's choice if valid
     */
